...
import { BookOpen, Mail, Lock, Eye, EyeOff, ArrowLeft, Zap, User } from 'lucide-react';
...
const LoginStudent = ({ onLogin }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const success = onLogin(formData.email, formData.password, 'student', formData.username);
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <motion.div
          ...
          className="text-center"
        >
          <p className="text-gray-600 mb-4">Not a student?</p>
